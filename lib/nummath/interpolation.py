...
from lib.nummath import graphing, linear_system
import numpy as np
...
class CubicSplineInterPol(_InterPol):
    ...
    def _curvature(self):
        ...
        self._k = linear_system.B3DLinSys(c, d, e, b).solve()
...
class PolyFit(_CurveFit):
    ...
    def solve(self):
        self._c = linear_system.GaussElimin(self._a, self._b, pivot_on=True).solve()
        self._solved = True
