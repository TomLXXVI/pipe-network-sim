...
from lib.pypeflow.core import Fluid
from lib.pypeflow.core import Pump
from lib.pypeflow.core import ResistanceCoefficient
    ...
    def add_fitting(self, **kwargs):
        ...
        **kwargs:**
        ...
        if not math.isnan(Kv):
            f = Fitting.create_w_flow_rate(type_, self._pipe.fluid, self._pipe.flow_rate,
                                           Kv, self._pipe.cross_section.diameter)
        else:
